            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ background: "#EFF6FF", border: "1px solid #BFDBFE", borderRadius: "4px", padding: "10px 14px", color: "#1E40AF", fontSize: "10.5px" }}>
                        <strong>ENGINEERING DESIGN BASIS NOTICE:</strong> This process design package is derived from first-principles electrosorption and membrane mass transport governing equations. Sizing dimensions, power demands, and hydrodynamic parameters represent engineering calculations based on the entered design parameters. Validate with experimental data before final equipment selection.
                    </div>
                        ...
                        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "10.5px" }}>
                            ...
                            <tbody>
                                ...
                                <tr style={{ borderBottom: "1px solid #F1F5F9" }}>
                                    ...
                                    <td style={{ padding: "4px 8px", textAlign: "right", color: "#854D0E", fontWeight: "700" }}>RATIO = {(feedTds / Math.max(1, feedConductivity)).toFixed(2)}</td>
                                </tr>
                                <tr style={{ borderBottom: "1px solid #F1F5F9" }}>
