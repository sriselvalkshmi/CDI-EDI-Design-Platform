...
export default function PIDDiagram() {
    ...
    return (
        <div className="panel pid-panel cad-section" style={{ background: "#FFFFFF", border: "1px solid #CBD5E1", borderRadius: "4px", padding: "14px 16px", marginBottom: "12px", width: "100%", boxSizing: "border-box", fontFamily: "Inter, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" }}>
