...
export const generateEngineeringReportPDF = ({
    ...
    try {
        ...
        // Selected Tech & Engineering Selection
        const recTech = aiResult?.selectedTechnology || technology || "CDI";
        const optMode = optimization?.mode || "Deterministic Optimization";
        ...
        autoTable(doc, {
            ...
            body: [
                ...
                ["Engineering Selection", recTech],
                ["Model Status", engData.modelStatus || "First-Principles Computational Model"],
        ...
        // 6. Optimization Summary - [Design Optimization] Table
        autoTable(doc, {
            startY: startY,
