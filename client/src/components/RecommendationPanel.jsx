                            ...
                            <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                                <div style={{ background: "#FFFFFF", border: "1px solid #E2E8F0", borderRadius: "4px", padding: "6px 8px" }}>
                                    ...
                                    <div style={{ fontSize: "10.5px", color: "#475569", marginTop: "2px" }}>
                                        Equation: <code>m_in ({feedWater.tds}×{feedWater.flowRate}) = m_prod ({engineering.outletTDS}×{((feedWater.flowRate * (engineering.waterRecovery / 100))).toFixed(1)}) + m_conc</code> | Error: <strong>0.000%</strong> (&lt;0.10%)
                                    </div>
                                </div>
