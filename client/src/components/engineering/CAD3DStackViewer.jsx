...
export default function CAD3DStackViewer({ technology: propTech }) {
    ...
    return (
        <div className="cad-panel" style={{
            ...
            <div className="cad-panel-header" style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "8px", borderBottom: "1px solid #E2E8F0", paddingBottom: "8px", flexWrap: "wrap", gap: "8px" }}>
                <div>
                    <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                        <span style={{ fontSize: "15px", fontWeight: "700", color: "#0F172A" }}>
                            Parametric Engineering Visualization ({technologyLabel} Stack Geometry)
                        </span>
                        <span style={{ background: "#EFF6FF", color: "#0284C7", border: "1px solid #BAE6FD", padding: "2px 8px", borderRadius: "4px", fontSize: "10px", fontWeight: "700" }}>
                            CAD VISUALIZATION ONLY (NOT PHYSICAL VALIDATION)
                        </span>
                    </div>
                    <div style={{ fontSize: "11px", color: "#64748B", marginTop: "2px" }}>
                        Cell Pairs: <strong style={{ color: "#0F172A" }}>{totalCellPairs}</strong> | Modules: <strong style={{ color: "#0F172A" }}>{numberOfModules}</strong> | Area: <strong style={{ color: "#0F172A" }}>{electrodeArea} cm²</strong> | Stack Size: <strong style={{ color: "#0F172A" }}>{sideDimMm} × {sideDimMm} × {totalThicknessMm} mm</strong>
                    </div>
                    <div style={{ fontSize: "10.5px", color: "#475569", fontStyle: "italic", marginTop: "2px" }}>
                        {
                            ...
                            }[tech] || "Layer Stack Order: Feed Channel → Ion Exchange Membranes → Porous Electrodes → Product Channel"
                        }
                    </div>
                </div>
            ...
            {/* CAD DISCLAIMER BANNER */}
            <div style={{ background: "#F1F5F9", border: "1px solid #CBD5E1", borderRadius: "6px", padding: "6px 10px", marginBottom: "8px", fontSize: "11px", color: "#475569", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span style={{ fontWeight: "700", color: "#0F172A" }}>3D Stack Parametric Visualizer</span>
                <span style={{ background: "#FEF3C7", color: "#B45309", padding: "2px 8px", borderRadius: "4px", fontWeight: "700", fontSize: "10px" }}>
                    CAD VISUALIZATION ONLY — NOT PHYSICAL VALIDATION
                </span>
            </div>
            ...
            <div ref={containerRef} className="cad-viewport">
                ...
                <div className="cad-telemetry">
                    <div style={{ color: "#0284C7", fontWeight: "700", marginBottom: "2px" }}>Calculated Engineering Telemetry</div>
                    <div style={{ fontSize: "10px", color: "#64748B", marginBottom: "4px" }}>(Live calculated model telemetry — not physical sensor data)</div>
                    <div style={{ color: "#475569" }}>Flow Velocity: <strong style={{ color: "#0F172A" }}>{flowVelocity.toFixed(3)} m/s</strong></div>
                    <div style={{ color: "#475569" }}>Pressure Drop: <strong style={{ color: "#0F172A" }}>{pressureDrop.toFixed(0)} Pa</strong></div>
                    <div style={{ color: "#475569" }}>Stack Power: <strong style={{ color: "#0F172A" }}>{power.toFixed(1)} W</strong></div>
                    <div style={{ color: "#475569" }}>System Voltage: <strong style={{ color: "#0F172A" }}>{systemVoltage.toFixed(1)} V DC</strong></div>
                    <div style={{ color: "#475569" }}>Operating Current: <strong style={{ color: "#0F172A" }}>{operatingCurrent.toFixed(2)} A</strong></div>
                </div>
                ...
                <div className="cad-dimensions">
                    <div style={{ borderBottom: "1px solid #E2E8F0", paddingBottom: "4px", marginBottom: "6px" }}>
                        <div style={{ fontSize: "11px", fontWeight: "700", color: "#0284C7", marginBottom: "3px" }}>Calculated Dimensions</div>
            ...
            <div style={{ marginTop: "6px", borderTop: "1px solid #E2E8F0", paddingTop: "5px", fontSize: "10.5px", color: "#64748B", textAlign: "center" }}>
                <strong>Parametric 3D Engineering Visualization:</strong> Geometry is generated from current engineering design parameters for CAD visualization purposes.
            </div>
        </div>
    );
}
