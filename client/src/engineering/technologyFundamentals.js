...
export const TECHNOLOGY_FUNDAMENTALS = {
    ...
    MCDI: {
        ...
        operatingPrinciple: "Membrane-assisted electrosorption where Cation Exchange Membranes (CEM) and Anion Exchange Membranes (AEM) are placed in front of fixed porous carbon electrodes to block co-ion expulsion.",
        electrodeConfiguration: "Fixed porous carbon electrodes (cathode and anode) attached to current collectors.",
        membraneConfiguration: "Ion-exchange membranes: CEM adjacent to cathode; AEM adjacent to anode.",
        feedWaterFlowDirection: "Flow-between channel bounded by CEM and AEM sheets.",
        productWaterFlowPath: "High-purity desalinated product water produced during the charging (adsorption) phase.",
        concentrateRejectFlowPath: "Concentrated brine reject stream produced during electrical zero-voltage or reverse-polarity desorption phase.",
        ...
        regenerationMechanism: "Fast desorption by voltage zeroing or reverse-polarity electrical potential without re-adsorbing co-ions, yielding high charge efficiency (> 85–95%).",
    ...
    FCDI: {
        ...
        operatingPrinciple: "Continuous desalination utilizing pumpable carbon slurry electrodes (suspended carbon particles in aqueous electrolyte) flowing continuously behind ion-exchange membranes.",
